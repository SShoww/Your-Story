...
> ภาพรวมการกระจาย User Stories และ Technical Enablers ทั้งหมด 31 รายการจาก `01-product-backlog.md` ลงสู่ **4 Sprints (รวม 128 SP)** โดยตัวเลข Story Points ทั้งหมดผ่านการตรวจสอบความถูกต้องทางคณิตศาสตร์ตรงกันสมบูรณ์ทุกแกน:
...
| **Sprint 3** | 2026-09-29 — 2026-10-12 | **Atmosphere, Narrative & 4-Wall Shelter:** บทนำ Prologue, ระบบห้อง 4 ทิศ (Samsara Room), และ DialogueBox | **28 SP** | 🔄 **Active** (13/28 SP Done, Core Implemented) |
| **Sprint 4** | 2026-10-13 — 2026-10-26 | **2-Phase Care Mini-Games & Release:** Dynamic Wheel Sweet Spot, มินิเกม 4 แบบ, Daily Report และบทสรุป | **26 SP** | 🔲 **Draft** (Next Milestone) |
| **Total** | **8 สัปดาห์ (ตลอดเทอม)** | **BePal Full Prototype & Game Release** | **128 SP** | **74/128 SP Completed** |

```mermaid
gantt
    title BePal Roadmap — Sprint 1-4 (128 SP)
    ...
    Prologue, Doorstep & DialogueBox (PR #16):done, s3_1, 2026-09-29, 10d
    4-Wall Panoramic Shelter Navigation (PR #16):done, s3_2, 2026-09-29, 14d
    Shelter Art Backgrounds & Clues Staging :active, s3_3, 2026-10-05, 7d
...
| **US-10**   | Playtest Screenshot & Capture Pipeline   | โชว์ (Lead Prog)     | Should Have | 3      | ✅ Done         | โชว์สร้างคำสั่ง `--screenshot` (22 เฟรม) และปุ่ม `F12` |
...
| **TECH-02** | Automated Unit Testing (`BePal.Tests`)   | โชว์ (Lead Prog)     | Should Have | 4      | ✅ Done         | โชว์สร้างโปรเจกต์ xUnit และเขียนเทสต์ครอบคลุม State (32/32 tests ผ่าน) |
...
## 4. Sprint 3: Atmosphere, Narrative & 4-Wall Shelter (กำลังดำเนินการ 🔄)
**ระยะเวลา:** 2026-09-29 — 2026-10-12 | **Estimated Velocity:** 28 SP | **Status:** 🔄 In Progress (13 SP Done, Core Narrative & Shelter Engine Merged in PR #16 & PR #17)

| ID | User Story / Task | ผู้รับผิดชอบหลัก | MoSCoW | SP | Status | คำอธิบายความรับผิดชอบ |
| --- | --- | --- | --- | --- | --- | --- |
| **US-15** | Prologue & Daily Doorstep Narrative Scripts | ภูมิ (Pooh / Design) | Must Have | 4 | ✅ Done | ภูมิเขียนบทนำ Day 1 และบทพัสดุมาส่ง Day 2–5 ภาษาอังกฤษ โชว์ต่อเข้าระบบใน `NarrativeScripts.cs`, `PrologueScreen`, `DoorstepScreen` (PR #16) |
| **TECH-05** | Unified DialogueBox Subsystem | โชว์ (Lead Prog) | Must Have | 4 | ✅ Done | โชว์สร้างระบบข้อความพิมพ์ดีด typewriter, fast-reveal, dynamic word wrap, และ prompt `[YES]/[NO]` ผ่าน unit tests 8/8 (PR #16) |
...
| **US-20** | 4-Wall Panoramic Shelter Navigation Engine | โชว์ (Lead Prog) | Must Have | 5 | ✅ Done | โชว์พัฒนา `PanoramicRoomScreen` หมุน 360 องศา 4 ทิศ (A/D, ลูกศร), Hitbox สำรวจสิ่งของ 4 ผนัง, และคลิกยืนยันเริ่มแคร์ (PR #16) |
...
| **รวม** | **Sprint 3 Velocity** | - | - | **28** | - | โชว์: 9 SP (9 SP Done), ซุง: 3 SP (In Progress), ภูมิ: 7 SP (4 SP Done), เดียร์: 9 SP (5 SP In Progress) |

---

## 5. Sprint 4: 2-Phase Care Mini-Games & Release (เตรียมความพร้อม 🔲)
**ระยะเวลา:** 2026-10-13 — 2026-10-26 | **Estimated Velocity:** 26 SP | **Status:** 🔲 Planned (Immediate Next Milestone ตาม `docs/handoff.md`)
...
| **QA-02** | End-to-End Playtesting & Final Balance QA | ภูมิ (Pooh / Design) | Should Have | 3 | 🔲 Backlog | ภูมิทดสอบลูปเต็ม 5 วัน ตรวจสอบความสมดุลรอบสุดท้ายและ Regression QA |
...
| สมาชิก | บทบาท (Role) | Sprint 1 (Done) | Sprint 2 (Active) | Sprint 3 (Active) | Sprint 4 (Draft) | รวมทั้งโปรเจกต์ (SP) | สถานะความคืบหน้าปัจจุบัน |
| --- | --- | --- | --- | --- | --- | --- | --- |
| **วศิน (โชว์)** | **Lead Programmer** | 14 SP | 25 SP | 9 SP | 12 SP | **60 SP** | 45 SP Done (75%) |
| **ปีย์ตะวัน (ซุง)** | **Game Designer** | 15 SP | 6 SP | 3 SP | 4 SP | **28 SP** | 18 SP Done (64%) |
| **ภูมิพัฒน์ (ภูมิ / Pooh)** | **Flex (Design & Audio)** | 0 SP | 7 SP | 7 SP | 7 SP | **21 SP** | 4 SP Done (19%) |
| **ธัญญรัตน์ (เดียร์)** | **2D Art & UI Lead** | 0 SP | 7 SP | 9 SP | 3 SP | **19 SP** | 4 SP Done (21%) |
| **รวม Story Points ต่อ Sprint** | - | **29 SP** | **45 SP** | **28 SP** | **26 SP** | **128 SP** | **74 SP Done (58% Total)** |

---

## 7. Integrated Pull Requests & Delivery Traceability (สรุปการส่งมอบตาม Gitflow)
