...
### Standup Notes (Week 09 — เดียร์)
- **เมื่อวาน:** —
- **วันนี้:** ทำ Sprint-Backlog และร่าง Sprite Animation ท่าเคลื่อนไหวหลักของสัตว์เลี้ยง
- **Blocked:** ออกแบบระบบหน้าเมนูแบบง่ายเพื่อให้เห็นภาพ
