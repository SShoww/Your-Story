...
- **ซุง (Zunk):** Game Designer (ระบบกลไก, ตัวเลข Balance, กฎพฤติกรรมสัตว์, สูตรคำนวณ และระบบเศรษฐกิจ)
- **ภูมิ (Pooh):** Flex (leans towards Design) / Audio Support (เนื้อเรื่อง/บทสนทนา, Playtesting QA, และเสียง SFX/BGM)
- **เดียร์ (Dear):** 2D Art & UI Lead (วาดภาพ Sprite สัตว์, ภาพบอสพ่อค้าเร่, ฉากหลัง, และ UI Graphics)
...
flowchart TD
    subgraph Zunk_Design["1. Game Designer (ซุง / Zunk)"]
        Z1[Balance Matrix & Decay Formulas] --> Z2[10-Attempt QTE Math & Precision]
        Z2 --> Z3[Shop Pricing & Equipment Specs]
        Z3 --> Z4[GDD v2 Specs for Show]
    end

    subgraph Pooh_Flex["2. Flex Design & Audio (ภูมิ / Pooh)"]
        P1[Day 2 Knock Knock Script] --> P2[Day 3 Merchant 5,000G Dilemma & Endings]
        P2 --> P3[Lead QA Playtesting & Balance Tuning]
    ...
    subgraph Dear_Art["3. 2D Art & UI Lead (เดียร์ / Dear)"]
        ...
        A3 --> A4[Action Badges & 8 Item Icons]
    end
...
| **T-03** | Pet Stats Model & Mathematical Decay Rules | ซุง (Game Designer) | Must | 6 | ✅ Done | Sprint 1 |
| **T-04** | Discrete Energy Budget (6 AP) System | โชว์ (Lead Prog) | Must | 5 | ✅ Done | Sprint 1 |
| **T-05** | Sickness & Health Status Effects Design | ซุง (Game Designer) | Must | 5 | ✅ Done | Sprint 1 |
| **T-06** | Day 1 Thunderstorm Disaster & Calming QTE | ซุง (Game Designer) | Must | 4 | ✅ Done | Sprint 1 |
...
| **T-09** | Day 2 "Knock Knock !!" Narrative Script | ภูมิ (Flex / Audio) | Must | 4 | 🔍 Review | Sprint 2 |
| **T-10** | Combat & Taming Balance Matrix | ซุง (Game Designer) | Should | 3 | 🔍 Review | Sprint 2 |
| **T-11** | Screen Hierarchy & State Transitions | โชว์ (Lead Prog) | Should | 3 | 🔍 Review | Sprint 2 |
| **T-12** | Content Pipeline & Automated Screenshot Harness | โชว์ (Lead Prog) | Should | 2 | 🔍 Review | Sprint 2 |
| **T-13** | Toothless Combat Taming Arena & QTE | โชว์ (Lead Prog) | Must | 5 | ⏳ In Progress | Sprint 2 |
| **T-14** | Acid Spit Dodge Zone & Counter-Attack | โชว์ (Lead Prog) | Must | 5 | ⏳ In Progress | Sprint 2 |
| **T-15** | Toothless Sprite Sheet (4 ท่า: Idle/Angry/Attack/Tamed) | เดียร์ (2D Art Lead) | Must | 3 | ⏳ In Progress | Sprint 2 |
| **T-16** | Dynamic Pet Emotional Sprites (Coco 4 ท่า) | เดียร์ (2D Art Lead) | Should | 4 | ⏳ In Progress | Sprint 2 |
| **T-17** | Core Sound Effects Production (9 SFX) | ภูมิ (Flex / Audio) | Should | 3 | ⏳ In Progress | Sprint 2 |
| **T-18** | Lead QA Playtesting & QTE Timing Calibration | ภูมิ (Flex / Audio) | Should | 3 | ⏳ In Progress | Sprint 2 |
| **T-19** | MonoGame Audio Engine Integration | โชว์ (Lead Prog) | Should | 3 | ⏳ In Progress | Sprint 2 |
| **T-20** | The Traveling Collector Boss Sprites (4 ท่า) | เดียร์ (2D Art Lead) | Must | 4 | 📋 Ready | Sprint 3 |
| **T-21** | 5-Item Shop Catalog & 3 Equipment Balance | ซุง (Game Designer) | Should | 4 | 📋 Ready | Sprint 3 |
| **T-22** | Boss Combat 3 Phases Math & Ending Conditions | ซุง (Game Designer) | Must | 3 | 📋 Ready | Sprint 3 |
| **T-23** | Base Habitat Background & Environments (5 ฉาก) | เดียร์ (2D Art Lead) | Must | 5 | 📋 Ready | Sprint 3 |
| **T-24** | Item Icons & UI Dialogue Frames | เดียร์ (2D Art Lead) | Should | 3 | 📋 Ready | Sprint 3 |
| **T-25** | Atmospheric Cozy & Boss BGM Soundtrack (5 แทร็ก) | ภูมิ (Flex / Audio) | Should | 3 | 📋 Ready | Sprint 3 |
| **T-26** | End-to-End 3-Day Playtesting & Release QA | ภูมิ (Flex / Audio) | Must | 3 | 📋 Ready | Sprint 3 |
...
| **T-31** | Day 3 Traveling Merchant Lore & Buyout Script | ภูมิ (Flex / Audio) | Must | 4 | 🗄️ Backlog | Sprint 3 |
| **T-32** | Endings A & B Epilogue Narrative Scripts | ภูมิ (Flex / Audio) | Must | 4 | 🗄️ Backlog | Sprint 3 |
