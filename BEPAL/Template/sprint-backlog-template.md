...
<!-- ภาพรวมว่า Story ไหนไปอยู่ Sprint ไหนตลอด 3 Sprint — ไม่ต้องระบุคนรับผิดชอบ/Status ที่นี่ ส่วนนั้นอยู่ใน sprint-plan-[NN].md ของ Sprint ที่กำลังทำ -->
...
## Timeline (3 Sprint, Sprint ละ 2 สัปดาห์, สิ้นสุดก่อน 12 ต.ค. 2026)

| Sprint | เริ่ม | สิ้นสุด |
|---|---|---|
| Sprint 1 | 2026-09-01 | 2026-09-14 |
| Sprint 2 | 2026-09-15 | 2026-09-28 |
| Sprint 3 | 2026-09-29 | 2026-10-11 |

```mermaid
gantt
    title Project Timeline — Sprint 1-3 (Deadline Before 2026-10-12)
